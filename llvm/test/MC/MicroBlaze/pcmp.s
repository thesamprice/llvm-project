...
#------------------------------------------------------------------------------
# pcmpbc rD, rA, rB  — byte compare; rD = count of bytes in rA matching rB
#
# pcmpbc r3, r5, r7  — rD=r3=3, rA=r5=5, rB=r7=7
#   opcode=0x21 (100001), func=0x400 (10000000000)
# Word = 0x21<<26 | 3<<21 | 5<<16 | 7<<11 | 0x400
#      = 0x84000000 | 0x00600000 | 0x00050000 | 0x00003800 | 0x00000400
#      = 0x84653C00
# LE: 00 3C 65 84
#------------------------------------------------------------------------------
# CHECK: pcmpbc r3, r5, r7             # encoding: [0x00,0x3c,0x65,0x84]
  pcmpbc r3, r5, r7
