...
# opcode 0x2E (101110) for MBAR: rD=0b00010=2
...
# mbar 0 — opcode=0x2E=101110, rD=0b00010=2, rA=0, imm=0
# byte3: 1,0,1,1,1,0,0,0 = 0xB8 (opcode=101110, rD[4:3]=00)
# byte2: rD[2:0]=010, rA=00000 → 0,1,0,0,0,0,0,0 = 0x40
# LE: 00 00 40 B8
# CHECK: mbar 0                      # encoding: [0x00,0x00,0x40,0xb8]
  mbar 0
