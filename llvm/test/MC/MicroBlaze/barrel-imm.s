...
#------------------------------------------------------------------------------
# bsifi rD, rA, width, shift  — insert bit field  (I=1, E=0)
# I=1 → bit[15]=1: 0x8000.
# GAS convention: bsifi takes (width, shift) and encodes
#   IMMW = shift + width - 1 (NOT the raw width value)
#   IMMS = shift
#
# bsifi r3, r5, 7, 3  — width=7, shift=3 → IMMW=3+7-1=9, IMMS=3
#   bits[10:6]=9=0b01001: bit9=1,bit6=1
#   bits[4:0]=3=0b00011
#   Lower 16: 1_0_000_01001_0_00011 = 1000_0010_0100_0011 = 0x8243
# Word = 0x64000000 | 3<<21 | 5<<16 | 0x8243 = 0x64658243
# LE: 43 82 65 64
#
# bsifi r3, r5, 1, 0  — width=1, shift=0 → IMMW=0, IMMS=0
#   Lower 16: 0x8000 (I=1, IMMW=0, IMMS=0)
#   LE: 00 80 65 64
#------------------------------------------------------------------------------
# CHECK: bsifi r3, r5, 7, 3           # encoding: [0x43,0x82,0x65,0x64]
  bsifi r3, r5, 7, 3

# CHECK: bsifi r3, r5, 1, 0           # encoding: [0x00,0x80,0x65,0x64]
  bsifi r3, r5, 1, 0
